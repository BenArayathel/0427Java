...
import com.pzero.v1.business.services.user.SingletonUser;
import com.pzero.v1.business.validations.Validation;
import com.pzero.v1.persistence.models.Account;
import com.pzero.v1.presentation.AccountMenu;
import com.pzero.v1.presentation.FinishRegister;
import com.pzero.v1.presentation.LoginForm;
import com.pzero.v1.presentation.OpeningAccount;
import com.pzero.v1.presentation.PendingAccountMenu;
import com.pzero.v1.presentation.TransferMenu;

public class Main {
	
	public final static Logger loggy = Logger.getLogger(Main.class);
	public final static SingletonUser sUser = SingletonUser.getUser();
	public final static Validation vd = new Validation(); 
	public final static PersonService personSrv = new PersonServiceImplementation();
	public final static AccountService accountSrv = new AccountServiceImpl();
	public final static PendingApprovalService pApprovalSrv = new PendingApprovalSrvImpl();
	public final static TransferService transferSrv = new TransferServiceImpl();
