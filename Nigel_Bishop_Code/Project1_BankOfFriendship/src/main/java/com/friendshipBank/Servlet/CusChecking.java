...
public class CusChecking extends HttpServlet{
		...
		transactionService transService = new transactionServiceImpl();
			...
			try 
        	{
        		...
        		if(accStat.equals(accStatus)) {
            		...
            		Double depositAmount = bankAccount1.getBalance();
            		Double newBalance = currentBalance + depositAmount;
            		
        			//DEPOSIT
            		bankService.updateBankAccountBalance(userAccess.getCustomerID(), checkAccType, newBalance);
            		System.out.println("SYSTEM: $" + depositAmount + " HAS BEEN DEPOSIT INTO " + userAccess.getCustomerID() + " CHECKING ACCOUNT");
