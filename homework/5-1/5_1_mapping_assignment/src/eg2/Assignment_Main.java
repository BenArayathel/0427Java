...
//		System.out.println("Printing all employees who have more than 10 years of experience.");
//		for (Entry<Integer, Employee> e: empMap.entrySet()) {
...
//		System.out.println("Printing all employees whose name ends with either 'n' or 'a'.");
//		for (Entry<Integer, Employee> e: empMap.entrySet()) {
//			if (e.getValue().getName().substring(e.getValue().getName().length()-1).matches("n||a")) {
//				System.out.println(e.getKey());
//			}
//		}
...
//		System.out.println(e.getValue().getName().substring(0,1));
		/*
		 * Print Ids of employees who has more than 10 years of exp - DONE
