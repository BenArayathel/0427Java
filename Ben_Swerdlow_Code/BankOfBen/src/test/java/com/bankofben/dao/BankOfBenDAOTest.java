...
public class BankOfBenDAOTest {
	...
	public void testAccountCreationDeletion() throws BusinessException, ClassNotFoundException, SQLException {
		double validBalance = 9743.25;
		
		String customerId = "CUCAAA2000100000";
		
		Account account = new Account(1234567890, validBalance, customerId, true);
		...
		assertArrayEquals(new double[] {validBalance}, new double[] {account.getBalance()}, 0.01);
	...
	public void testAccountCreationInvalidStartingBalance() throws BusinessException {
		double invalidBalance = 10;
		String customerId = "CUCAAA2000100000";
		Account account = new Account(1234567890, invalidBalance, customerId, true);
		account = dao.createAccount(account);
	}
