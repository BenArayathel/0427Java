...
public class SummaryServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Cookie cookies[] = request.getCookies();// will only get the client cookies specific to this application
		...
		out.print("<td>"+request.getParameter("year")+"</th>");
		out.print("</tr>");
		out.print("<tr>");
		out.print("<th>"+"GPA"+"</th>");
		out.print("<td>"+request.getParameter("score")+"</th>");
		out.print("</tr>");
		out.print("</tr>");
		out.print("<tr>");
		out.print("<th>"+"Major"+"</th>");
		out.print("<td>"+request.getParameter("major")+"</th>");
		out.print("</tr>");
